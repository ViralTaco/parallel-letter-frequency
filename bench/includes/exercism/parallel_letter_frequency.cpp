...
namespace {
  [[nodiscard]] std::unordered_map<char, std::size_t> frequency(
...
parallel_letter_frequency::exercism::frequency(std::vector<std::string_view> const& texts) {
  std::vector<std::unordered_map<char, std::size_t>> freqs(texts.size());
  ...
  std::unordered_map<char, std::size_t> totals{};
