...
#ifndef vt_parallel_letter_frequency_v2_1_1
#define vt_parallel_letter_frequency_v2_1_1 "com.viraltaco.letter-frequency v" "2.1.1"
...
namespace parallel_letter_frequency::inline v2_1_1 {
class frequency {
public:
  ...
  public:
    ...
    [[nodiscard]] auto empty() const noexcept -> bool {
      return std::ranges::all_of(self | std::views::take(26), [](auto c) { return !c; });
    }
...
#endif  // ndef vt_parallel_letter_frequency_v2_1_1
