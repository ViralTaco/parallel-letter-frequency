...
#ifndef vt_parallel_letter_frequency_v1_1_6
#define vt_parallel_letter_frequency_v1_1_6 "com.viraltaco.letter-frequency v" "1.1.6"
...
namespace parallel_letter_frequency::inline v1_1_6 {
class frequency {
public:
  ...
  protected:
    ...
    auto index_of(const auto c) noexcept -> size_type {
...
#endif  // ndef vt_parallel_letter_frequency_v1_1_6
